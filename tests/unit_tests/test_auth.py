...
from epic.cli.auth_cli import app, authenticate, store_token, SESSION_FILE
import os
...
def test_logout_success(monkeypatch, temp_token_file):
    ...
    assert "Logout successful." in result.output, "The success message should be in the output"
